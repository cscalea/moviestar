        ...
        <div class="row"> 
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="bio" id="bio" placeholder="Onde você trabalha, o que você faz"><?= $userData->bio ?></textarea>
            </div>
          </div>    
        </div> 
      </form> 
      <div class="row" id="change-password-container">
        <div class="col-md-4">
          ...
          <form action="<?= $BASE_URL ?>user_process.php" method="POST">
            ...
            <div class="form-group">
              <label for="confirmpassword" name="confirmpassword" rows="5" placeholder="Conte quem você é, o que faz, onde trabalha: ">Confirmação de senha </label>
